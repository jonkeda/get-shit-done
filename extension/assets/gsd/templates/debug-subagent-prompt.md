...
Template for delegating to gsd-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
**From /gsd-debug:**
```
Delegate to agent: gsd-debugger
...
For checkpoints, delegate to fresh agent with:
