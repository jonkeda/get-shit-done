...
**CI Pipeline:**
- GitHub Actions
  - Workflows: test.yml (on PR), deploy.yml (on merge to main)
  - Secrets: NPM_TOKEN, VERCEL_TOKEN in GitHub repo secrets
```
</good_examples>
...
- Internal module dependencies (that's ARCHITECTURE.md or STRUCTURE.md)
- Technology stack (that's STACK.md)
- How APIs work internally (defer to code)
- Full API documentation (link to external docs)

**When filling this template:**
- Check package.json for SDK dependencies
- Search for API keys, env vars
- Look for webhook endpoints
- Review CI/CD config files
- Check deployment configuration

**Useful for phase planning when:**
- Adding new external integrations
- Understanding existing service dependencies
- Planning infrastructure changes
- Auditing security of external connections
</guidelines>
