...
description: 'Prompt engineering assistant with phase-based workflow for creating and validating prompts, agents, and instructions files'
maturity: stable
handoffs:
  - label: "💡 Update/Create"
...
* Sandbox root is `.spxcode/Sandbox/`.
...
* Determine the next available instance number by checking existing folders in `.spxcode/Sandbox/`.
