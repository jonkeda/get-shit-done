...
tools: [read, createFile, execute, search]
...
You are roadmapping for ONE person (the user) and ONE implementer (the AI assistant).
...
Reference full template: `.gsd/templates/roadmap.md`
